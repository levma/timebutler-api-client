...
export declare const TIME_CLOCK_RESPONSE_RESULTS: readonly ["OK", "WARN_TIMECLOCK_ALREADY_RUNNING", "WARN_TIMECLOCK_ALREADY_PAUSED", "WARN_TIME_ENTRY_SAVED_WITH_MODIFICATIONS", "WARN_SHORT_BUSINESSTRIP_TIMECLOCK_NOT_RUNNING", "WARN_SHORT_BUSINESSTRIP_ALREADY_STARTED", "WARN_SHORT_BUSINESSTRIP_NOT_STARTED", "RESULT_ERR_INTERNAL_ERROR", "RESULT_ERR_TIMETRACKING_FEATURE_NOT_ACT", "RESULT_ERR_COMMAND_INVALID", "RESULT_ERR_USERID_INVALID", "RESULT_ERR_PROJECTID_INVALID", "RESULT_ERR_SERVICEID_INVALID", "RESULT_ERR_TIMECLOCK_NOT_STARTABLE_MAY_OVERLAP", "RESULT_ERR_TIMECLOCK_STOPPED_WITHOUT_SAVE_DUE_TO_OVERLAPPING", "RESULT_ERR_TIMECLOCK_STOPPED_WITHOUT_SAVE_DUE_TO_UNRESOLVABLE_CHANGE_REQUIREMENTS", "RESULT_ERR_TIMECLOCK_NOT_RUNNING", "RESULT_ERR_MIN_DURATION_OR_PAUSE_NOT_OK"];
/**
 ...
 */
export type TimeClockResponseResult = (typeof TIME_CLOCK_RESPONSE_RESULTS)[number];
export declare const TIME_CLOCK_STATES: readonly ["IDLE", "RUNNING", "PAUSED"];
/**
...
//# sourceMappingURL=time-clock-response.d.ts.map