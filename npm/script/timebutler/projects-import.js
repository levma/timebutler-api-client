...
exports.rawProjectsImport = rawProjectsImport;
exports.projectsImport = projectsImport;
 ...
 */
function rawProjectsImport(caller, csvdatafile) {
 ...
 */
async function projectsImport(caller, csvdatafile) {
    const str = "line;state;projectId\n" +
        (await rawProjectsImport(caller, csvdatafile));
    return (0, parse_csv_js_1.parseCsv)(str);
}
