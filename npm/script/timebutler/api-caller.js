...
exports.createTimebutlerApiCaller = exports.EXTENDED_ENDPOINTS = exports.ENDPOINTS = void 0;
exports.ENDPOINTS = [
    "absences",
    "users",
    "holidayentitlement",
...
exports.EXTENDED_ENDPOINTS = ["personnelfiles", "salaries"];
/**
...
async function callTimebutlerApi(normalApiKey, extendendApiKey, endpoint, params = {}, files) {
    let apiKey;
    if (exports.ENDPOINTS.includes(endpoint)) {
        apiKey = normalApiKey;
    }
    else if (exports.EXTENDED_ENDPOINTS.includes(endpoint)) {
 ...
 */
const createTimebutlerApiCaller = (apiKey, extendedApiKey = null) => callTimebutlerApi.bind(null, apiKey, extendedApiKey);
exports.createTimebutlerApiCaller = createTimebutlerApiCaller;
