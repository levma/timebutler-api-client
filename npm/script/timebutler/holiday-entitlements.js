...
exports.rawHolidayEntitlements = rawHolidayEntitlements;
exports.holidayEntitlements = holidayEntitlements;
 ...
 */
function rawHolidayEntitlements(caller, year) {
 ...
 */
async function holidayEntitlements(caller, year) {
    return (0, parse_csv_js_1.parseCsv)(await rawHolidayEntitlements(caller, year), (row) => {
        const result = {
