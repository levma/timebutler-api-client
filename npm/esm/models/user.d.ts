...
export interface CsvUser {
    ...
    Language: string;
    /** "234567,345678" */
    "User ID list of the user's manager (comma separated list, in case more than one user ID exists)": string;
    /** "false" */
...
export declare const USER_TYPES: readonly ["Employee", "Manager", "Admin"];
