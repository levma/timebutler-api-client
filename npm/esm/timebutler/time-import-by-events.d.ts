import type { TimeImportByEventsResponse } from "../models/time-import-by-events-response.js";
import type { UserIdentificationParamter } from "../models/user-identification-parameter.js";
 ...
 */
export declare function rawTimeImportByEvents(caller: TimebutlerApiCaller, csvdatafile: File, useridentification?: UserIdentificationParamter): Promise<string>;
/**
 ...
 */
export declare function timeImportByEvents(caller: TimebutlerApiCaller, csvdatafile: File, useridentification?: UserIdentificationParamter): Promise<TimeImportByEventsResponse>;
//# sourceMappingURL=time-import-by-events.d.ts.map