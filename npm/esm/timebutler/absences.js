 ...
 */
export function rawAbsences(caller, year) {
 ...
 */
export async function absences(caller, timeZone = "Europe/Berlin", year) {
    return parseCsv(await rawAbsences(caller, year), (row) => {
        const result = {
