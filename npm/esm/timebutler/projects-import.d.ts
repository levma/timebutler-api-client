 ...
 */
export declare function rawProjectsImport(caller: TimebutlerApiCaller, csvdatafile: File): Promise<string>;
/**
 ...
 */
export declare function projectsImport(caller: TimebutlerApiCaller, csvdatafile: File): Promise<ProjectImportResponse[]>;
//# sourceMappingURL=projects-import.d.ts.map