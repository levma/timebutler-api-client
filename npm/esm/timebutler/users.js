 ...
 */
export function rawUsers(caller) {
    return caller("users");
}
/**
 ...
 */
export async function users(caller, timeZone = "Europe/Berlin") {
    return parseCsv(await rawUsers(caller), (row) => {
        const result = {
            ...
            leavingDate: stringToDate(row["Date of separation from company (dd/mm/yyyy)"], timeZone),
